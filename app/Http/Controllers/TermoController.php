...
class TermoController extends Controller
{
    ...
    public function iniciarJogo()
    {
        ...
        $palavraSecreta = $this->palavras[array_rand($this->palavras)];
    ...
    public function validarTentativa(Request $request)
    {
        ...
        $palavraValida = in_array($palavra, $this->palavras);
        ...
        $tentativasRestantes =
            6 - self::$jogos[$idJogo]['tentativas'];
